## Contributing to DynamoDB Landscaper

♥ [DynamoDB Landscaper](https://github.com/Lionshead-io/dynamodb-gardener) and want to get involved? Thanks!
...
The [issue tracker](https://github.com/Lionshead-io/dynamodb-gardener/issues) is the preferred channel
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/dynamodb-gardener.git
   # Navigate to the newly cloned directory
   cd dynamodb-gardener
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Lionshead-io/dynamodb-gardener
   ```
